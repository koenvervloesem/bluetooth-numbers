...
If you experience bugs or general issues with ``bluetooth-numbers``, please have a look
...
You can help improve ``bluetooth-numbers`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``bluetooth-numbers`` documentation uses Sphinx_ as its main documentation compiler.
...
The documentation is written in the reStructuredText_ markup language.
   ...
   .. tip::
      ...
      propose changes in ``bluetooth-numbers``'s files. While this mechanism can
...
#. Install |pre-commit|_::
   ...
   ``bluetooth-numbers`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/koenvervloesem/bluetooth-numbers
.. _issue tracker: https://github.com/koenvervloesem/bluetooth-numbers/issues
.. <-- end -->
